...
//
//    // 전체 스터디 조회
//    public List<StudyRequestDTO> getAllStudy() {
//        return studyRepository.findAll().stream()
//                .map(StudyRequestDTO::new)
//                .collect(Collectors.toList());
//    }
//
//    // 스터디 등록
//    public StudyRequestDTO acceptStudy(Long id) {
...
//        return new StudyRequestDTO(updatedStudy);
//    }
//
//    // 스터디 등록 취소
//    public StudyRequestDTO unacceptStudy(Long id) {
//        Study study = studyRepository.findById(id)
//                .orElseThrow(() -> new IllegalArgumentException("스터디가 존재하지 않습니다: " + id));
