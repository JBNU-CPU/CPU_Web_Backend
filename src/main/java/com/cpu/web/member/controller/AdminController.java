...
//    @ApiResponse(responseCode = "200", description = "요청에 성공하였습니다.", content = @Content(mediaType = "application/json"))
//    public List<StudyRequestDTO> getAllStudies() {return adminService.getAllStudy();}
//
//    // 스터디 등록
//    @PutMapping("/study/{id}")
...
//        StudyRequestDTO updateStudyRequestDTO =  adminService.acceptStudy(id);
...
//        StudyRequestDTO updateStudyRequestDTO =  adminService.unacceptStudy(id);
//        return ResponseEntity.ok(updateStudyRequestDTO);
//    }
//
//    // 스터디 삭제
